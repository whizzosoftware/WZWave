...
/**
 * A RequestRequestTransaction is a transaction that is considered complete when:
 *
 * 1. An ACK is received
 * 2. A request is received of the same type as the frame that started the transaction
 *
 * @author Dan Noguerol
 */
public class RequestRequestTransaction extends AbstractDataFrameTransaction {
