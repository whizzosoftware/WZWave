...
public class ZensorNetAlarmSensor extends AlarmSensor {
    static public final byte ID = 0x04;

    public ZensorNetAlarmSensor(NodeInfo info, boolean listening, NodeListener listener) {
    ...
    public ZensorNetAlarmSensor(PersistenceContext pctx, Byte nodeId, NodeListener listener) {
