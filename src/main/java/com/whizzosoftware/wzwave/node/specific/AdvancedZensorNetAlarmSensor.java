...
public class AdvancedZensorNetAlarmSensor extends AlarmSensor {
    static public final byte ID = 0x05;

    public AdvancedZensorNetAlarmSensor(NodeInfo info, boolean newlyIncluded, boolean listening, NodeListener listener) {
    ...
    public AdvancedZensorNetAlarmSensor(PersistenceContext pctx, Byte nodeId, NodeListener listener) {
