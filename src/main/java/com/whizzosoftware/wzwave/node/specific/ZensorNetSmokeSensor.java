...
public class ZensorNetSmokeSensor extends AlarmSensor {
    static public final byte ID = 0x09;

    public ZensorNetSmokeSensor(NodeInfo info, boolean listening, NodeListener listener) {
    ...
    public ZensorNetSmokeSensor(PersistenceContext pctx, Byte nodeId, NodeListener listener) {
